...
import SendReply1 from './SendReply1'
        ...
        <View>
            ...
            <View style={{ flex: 6 }}></View>
                ...
                <View style={{ flex: 2, flexDirection: 'row'}}>
                    <SendReply1 count={item.reply_count} reply={item.reply} reply_id={item.reply_id}/>
                </View>
                
            </View>

            <Reply1 reply={item.reply} reply_id={item.reply_id}/>
            </View>
