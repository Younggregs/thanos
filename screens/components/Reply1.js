...
import SendReply2 from './SendReply2'
    ...
    return (
        <View>
            ...
            <View style={{ flex: 6 }}></View>
                ...
                <View style={{ flex: 1}}>
                    <Text style={{ fontWeight: 'bold', fontSize: 15}}>{item.votes}</Text>
                </View>
                <View style={{ flex: 2}}>
                    <Icon name='arrow-round-down'/>
                </View>
                <View style={{ flex: 2, flexDirection: 'row'}}>
                <SendReply2 count={item.reply_count} reply={item.reply} reply_id={item.reply_id}/>
                </View>
            </View>

            <Reply2 reply={item.reply} reply_id={item.reply_id}/>
            </View>
