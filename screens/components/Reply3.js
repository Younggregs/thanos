...
import SendReply4 from './SendReply4'
    ...
    return (
        <View>
            ...
            <View style={{ flex: 6 }}></View>
                ...
                <SendReply4 count={item.reply_count} reply={item.reply} reply_id={item.reply_id}/>
                </View>
            </View>

            <Reply4 reply={item.reply} reply_id={item.reply_id}/>
            </View>
