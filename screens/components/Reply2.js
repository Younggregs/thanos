...
import SendReply3 from './SendReply3'
    ...
    return (
        <View>
            ...
            <View style={{ flex: 6 }}></View>
                ...
                <SendReply3 count={item.reply_count} reply={item.reply} reply_id={item.reply_id}/>
                </View>
            </View>

            <Reply3 reply={item.reply} reply_id={item.reply_id}/>
            </View>
